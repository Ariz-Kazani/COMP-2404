...
void TestControl::launch()
{
    ...
    while (choice != 0)
    {
        ...
        {
        case 1:
            tester.recordMark(1, testAddPodcasts());
            break;
        case 2:
            tester.recordMark(2, testAddEpisodes());
            break;
        case 3:
            tester.recordMark(3, testGetEpisodesByHost());
            break;
        case 4:
            tester.recordMark(4, testGetEpisodesByCategory());
            break;
        case 5:
            tester.recordMark(5, testGetEpisodesByHostAndCategory());
            break;
        // case 6: testPrintCurrentEpisodeList(); break;
        case 6:
            tester.recordMark(6, testPlayCurrentEpisodeList());
            break;
        case 7:
            tester.recordMark(7, testAllAndMark(), 22);
            break;
        }
    }
...
int TestControl::testAddEpisodes()
{
    ...
    cout << endl
         << "Printing podcasts with episodes" << endl
         << endl;
    int errors = 0;
    int index = 0;
